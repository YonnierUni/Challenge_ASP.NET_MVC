    ...
    public class TrainingProductManager
    {
        ...
        private List<TrainingProduct> CreateMockData()
        {
            ...
            ret.Add(new TrainingProduct()
            {
                ...
                IntroductionDate = Convert.ToDateTime("8/22/2016"),
            ...
            ret.Add(new TrainingProduct()
            {
                ...
                IntroductionDate = Convert.ToDateTime("1/14/2018"),
            ...
            ret.Add(new TrainingProduct()
            {
                ...
                IntroductionDate = Convert.ToDateTime("9/30/2019"),
            ...
            ret.Add(new TrainingProduct()
            {
                ...
                IntroductionDate = Convert.ToDateTime("3/22/2020"),
            ...
            ret.Add(new TrainingProduct()
            {
                ...
                IntroductionDate = Convert.ToDateTime("11/12/2022"),
            ...
            ret.Add(new TrainingProduct()
            {
                ...
                IntroductionDate = Convert.ToDateTime("2/28/2023"),
